...
*   Para grabar tu respuesta, haz click en el icono del círculo con un micrófono dentro. El icono se pone de color rojo cuando se termina de formular la pregunta. Una vez esté de color rojo, podrás hacer click. Cuando termines de responder, vuelve a hacer click sobre el icono (un cuadrado blanco incrustado en un círculo rojo) 
...
*   Una evaluación resumida y detallada de tu desempeño.
